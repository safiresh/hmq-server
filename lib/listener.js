'use strict'
/**
 * Created by safi on 13/04/16 12:10 AM.
 */

var Listener, MessengerBase, net, internalMethods,
...
Listener = (function (_super) {
    ...
    Listener.prototype.startServer = function () {
        ...
        tcpServer = net.createServer(function (connection) {
            ...
            //connection.connectionId = "SER:" + shortId.generate();

            connection.on('close', function () {
                _this.remoteMethods['__CLOSE'][0](connection.connectionId);
            })
    ...
    Listener.prototype.prepare = function (message) {
        ...
        i = 0;
        if (internalMethods.indexOf(subject) == -1) {
            var _ref;
            (_ref = _this.remoteMethods["__EMIT"]) != null ? _ref[i++](message) : void 0;
        } else { // Server Methods
            message.reply = function (subject, json) {
                var payload;
                payload = {
                    subject : subject,
                    data    : json,
